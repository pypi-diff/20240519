# Comparing `tmp/altstore_proxy-1.2.1.tar.gz` & `tmp/altstore_proxy-1.2.2.tar.gz`
...
## Comparing `altstore_proxy-1.2.1.tar` & `altstore_proxy-1.2.2.tar`
...
### Comparing `altstore_proxy-1.2.1/LICENSE.md` & `altstore_proxy-1.2.2/LICENSE.md`

 * *Files identical despite different names*

### Comparing `altstore_proxy-1.2.1/PKG-INFO` & `altstore_proxy-1.2.2/PKG-INFO`
...
### Comparing `altstore_proxy-1.2.1/README.md` & `altstore_proxy-1.2.2/README.md`

 * *Files identical despite different names*

### Comparing `altstore_proxy-1.2.1/altstore_proxy/run.py` & `altstore_proxy-1.2.2/altstore_proxy/run.py`

 * *Files identical despite different names*

### Comparing `altstore_proxy-1.2.1/altstore_proxy.egg-info/PKG-INFO` & `altstore_proxy-1.2.2/altstore_proxy.egg-info/PKG-INFO`
...
### Comparing `altstore_proxy-1.2.1/setup.py` & `altstore_proxy-1.2.2/setup.py`
