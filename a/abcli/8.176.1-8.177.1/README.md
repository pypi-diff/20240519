# Comparing `tmp/abcli-8.176.1.tar.gz` & `tmp/abcli-8.177.1.tar.gz`
...
### Comparing `abcli-8.176.1/abcli/tests/test_plugins_metadata.py` & `abcli-8.177.1/abcli/tests/test_plugins_metadata.py`
