# Comparing `tmp/madokami-0.1.0.tar.gz` & `tmp/madokami-0.1.1.tar.gz`
...
### Comparing `madokami-0.1.0/madokami/api/__init__.py` & `madokami-0.1.1/madokami/api/__init__.py`
