# Comparing `tmp/eras-0.1.5.tar.gz` & `tmp/eras-0.1.6.tar.gz`
...
## Comparing `eras-0.1.5.tar` & `eras-0.1.6.tar`
...
### Comparing `eras-0.1.5/PKG-INFO` & `eras-0.1.6/PKG-INFO`
...
### Comparing `eras-0.1.5/setup.py` & `eras-0.1.6/setup.py`
...
### Comparing `eras-0.1.5/src/eras.egg-info/PKG-INFO` & `eras-0.1.6/src/eras.egg-info/PKG-INFO`
