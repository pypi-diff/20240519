# Comparing `tmp/sharedkernel-1.0.0.tar.gz` & `tmp/sharedkernel-1.1.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "sharedkernel-1.0.0.tar", last modified: Mon Apr 22 08:40:11 2024, max compression
+gzip compressed data, was "sharedkernel-1.1.0.tar", last modified: Sun May 19 06:30:11 2024, max compression
```

## Comparing `sharedkernel-1.0.0.tar` & `sharedkernel-1.1.0.tar`

### file list

```diff
@@ -1,32 +1,39 @@
-drwxrwxrwx   0        0        0        0 2024-04-22 08:40:11.878712 sharedkernel-1.0.0/
--rw-rw-rw-   0        0        0      273 2024-04-22 08:40:11.871713 sharedkernel-1.0.0/PKG-INFO
--rw-rw-rw-   0        0        0      932 2024-04-22 08:34:48.000000 sharedkernel-1.0.0/README.md
--rw-rw-rw-   0        0        0       42 2024-04-22 08:40:11.879711 sharedkernel-1.0.0/setup.cfg
--rw-rw-rw-   0        0        0      536 2024-04-22 08:39:43.000000 sharedkernel-1.0.0/setup.py
-drwxrwxrwx   0        0        0        0 2024-04-22 08:40:11.757712 sharedkernel-1.0.0/sharedkernel/
--rw-rw-rw-   0        0        0      622 2024-04-07 22:32:56.000000 sharedkernel-1.0.0/sharedkernel/common.py
--rw-rw-rw-   0        0        0      326 2024-04-08 09:14:39.000000 sharedkernel-1.0.0/sharedkernel/config.py
-drwxrwxrwx   0        0        0        0 2024-04-22 08:40:11.790713 sharedkernel-1.0.0/sharedkernel/database/
--rw-rw-rw-   0        0        0      190 2024-04-09 05:59:22.000000 sharedkernel-1.0.0/sharedkernel/database/adapter.py
--rw-rw-rw-   0        0        0     2412 2024-04-09 06:00:52.000000 sharedkernel-1.0.0/sharedkernel/database/repository_base.py
-drwxrwxrwx   0        0        0        0 2024-04-22 08:40:11.793712 sharedkernel-1.0.0/sharedkernel/enum/
--rw-rw-rw-   0        0        0      387 2024-04-07 22:39:14.000000 sharedkernel-1.0.0/sharedkernel/enum/error_code.py
-drwxrwxrwx   0        0        0        0 2024-04-22 08:40:11.822713 sharedkernel-1.0.0/sharedkernel/exception/
--rw-rw-rw-   0        0        0      319 2024-04-22 07:11:30.000000 sharedkernel-1.0.0/sharedkernel/exception/__init__.py
--rw-rw-rw-   0        0        0     1016 2024-04-08 09:11:03.000000 sharedkernel-1.0.0/sharedkernel/exception/exception.py
--rw-rw-rw-   0        0        0     3176 2024-04-22 07:11:48.000000 sharedkernel-1.0.0/sharedkernel/exception/exception_handlers.py
--rw-rw-rw-   0        0        0     1178 2024-04-22 06:50:49.000000 sharedkernel-1.0.0/sharedkernel/jwt_service.py
-drwxrwxrwx   0        0        0        0 2024-04-22 08:40:11.847712 sharedkernel-1.0.0/sharedkernel/objects/
--rw-rw-rw-   0        0        0      100 2024-04-22 06:50:23.000000 sharedkernel-1.0.0/sharedkernel/objects/__init__.py
--rw-rw-rw-   0        0        0      186 2024-04-07 22:32:56.000000 sharedkernel-1.0.0/sharedkernel/objects/base_document.py
--rw-rw-rw-   0        0        0      134 2024-04-08 09:19:23.000000 sharedkernel-1.0.0/sharedkernel/objects/jwt_model.py
--rw-rw-rw-   0        0        0      721 2024-04-08 09:11:09.000000 sharedkernel-1.0.0/sharedkernel/objects/result.py
--rw-rw-rw-   0        0        0       98 2024-04-07 22:32:56.000000 sharedkernel-1.0.0/sharedkernel/string_extentions.py
-drwxrwxrwx   0        0        0        0 2024-04-22 08:40:11.863713 sharedkernel-1.0.0/sharedkernel.egg-info/
--rw-rw-rw-   0        0        0      273 2024-04-22 08:40:11.000000 sharedkernel-1.0.0/sharedkernel.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      676 2024-04-22 08:40:11.000000 sharedkernel-1.0.0/sharedkernel.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2024-04-22 08:40:11.000000 sharedkernel-1.0.0/sharedkernel.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       45 2024-04-22 08:40:11.000000 sharedkernel-1.0.0/sharedkernel.egg-info/requires.txt
--rw-rw-rw-   0        0        0       13 2024-04-22 08:40:11.000000 sharedkernel-1.0.0/sharedkernel.egg-info/top_level.txt
-drwxrwxrwx   0        0        0        0 2024-04-22 08:40:11.859712 sharedkernel-1.0.0/test/
--rw-rw-rw-   0        0        0      697 2024-04-22 08:30:58.000000 sharedkernel-1.0.0/test/test.py
...
### Comparing `sharedkernel-1.0.0/README.md` & `sharedkernel-1.1.0/README.md`

 * *Files identical despite different names*

### Comparing `sharedkernel-1.0.0/setup.py` & `sharedkernel-1.1.0/setup.py`
...
### Comparing `sharedkernel-1.0.0/sharedkernel/common.py` & `sharedkernel-1.1.0/sharedkernel/common.py`

 * *Files identical despite different names*

### Comparing `sharedkernel-1.0.0/sharedkernel/database/repository_base.py` & `sharedkernel-1.1.0/sharedkernel/database/mongo_repository_base.py`
...
### Comparing `sharedkernel-1.0.0/sharedkernel/exception/exception.py` & `sharedkernel-1.1.0/sharedkernel/exception/exception.py`

 * *Files identical despite different names*

### Comparing `sharedkernel-1.0.0/sharedkernel/exception/exception_handlers.py` & `sharedkernel-1.1.0/sharedkernel/exception/exception_handlers.py`

 * *Files identical despite different names*

### Comparing `sharedkernel-1.0.0/sharedkernel/jwt_service.py` & `sharedkernel-1.1.0/sharedkernel/jwt_service.py`

 * *Files identical despite different names*

### Comparing `sharedkernel-1.0.0/sharedkernel/objects/result.py` & `sharedkernel-1.1.0/sharedkernel/objects/result.py`
