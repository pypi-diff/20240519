# Comparing `tmp/scrapegraphai-1.3.0.tar.gz` & `tmp/scrapegraphai-1.3.0b1.tar.gz`
...
### Comparing `scrapegraphai-1.3.0/.releaserc.yml` & `scrapegraphai-1.3.0b1/.releaserc.yml`
...
### Comparing `scrapegraphai-1.3.0/examples/bedrock/smart_scraper_bedrock.py` & `scrapegraphai-1.3.0b1/examples/bedrock/smart_scraper_bedrock.py`
...
### Comparing `scrapegraphai-1.3.0/examples/gemini/smart_scraper_gemini.py` & `scrapegraphai-1.3.0b1/examples/gemini/smart_scraper_gemini.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/gemini/xml_scraper_openai.py` & `scrapegraphai-1.3.0b1/examples/gemini/xml_scraper_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/gemini/inputs/books.xml` & `scrapegraphai-1.3.0b1/examples/gemini/inputs/books.xml`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/gemini/inputs/example.json` & `scrapegraphai-1.3.0b1/examples/gemini/inputs/example.json`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/gemini/inputs/plain_html_example.txt` & `scrapegraphai-1.3.0b1/examples/gemini/inputs/plain_html_example.txt`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/groq/search_graph_groq_openai.py` & `scrapegraphai-1.3.0b1/examples/groq/search_graph_groq_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/groq/smart_scraper_groq_ollama.py` & `scrapegraphai-1.3.0b1/examples/groq/smart_scraper_groq_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/groq/smart_scraper_groq_openai.py` & `scrapegraphai-1.3.0b1/examples/groq/smart_scraper_groq_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/huggingfacehub/smart_scraper_huggingfacehub.py` & `scrapegraphai-1.3.0b1/examples/huggingfacehub/smart_scraper_huggingfacehub.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/local_models/csv_scraper_ollama.py` & `scrapegraphai-1.3.0b1/examples/local_models/csv_scraper_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/local_models/json_scraper_ollama.py` & `scrapegraphai-1.3.0b1/examples/local_models/json_scraper_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/local_models/scrape_plain_text_ollama.py` & `scrapegraphai-1.3.0b1/examples/local_models/scrape_plain_text_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/local_models/scrape_xml_ollama.py` & `scrapegraphai-1.3.0b1/examples/local_models/scrape_xml_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/local_models/script_generator_ollama.py` & `scrapegraphai-1.3.0b1/examples/local_models/script_generator_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/local_models/search_graph_ollama.py` & `scrapegraphai-1.3.0b1/examples/local_models/search_graph_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/local_models/smart_scraper_ollama.py` & `scrapegraphai-1.3.0b1/examples/local_models/smart_scraper_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/local_models/xml_scraper_ollama.py` & `scrapegraphai-1.3.0b1/examples/local_models/xml_scraper_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/local_models/inputs/books.xml` & `scrapegraphai-1.3.0b1/examples/local_models/inputs/books.xml`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/local_models/inputs/example.json` & `scrapegraphai-1.3.0b1/examples/local_models/inputs/example.json`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/local_models/inputs/plain_html_example.txt` & `scrapegraphai-1.3.0b1/examples/local_models/inputs/plain_html_example.txt`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/mixed_models/search_graph_groq_ollama.py` & `scrapegraphai-1.3.0b1/examples/mixed_models/search_graph_groq_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/mixed_models/smart_scraper_mixed.py` & `scrapegraphai-1.3.0b1/examples/mixed_models/smart_scraper_mixed.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/mixed_models/inputs/books.xml` & `scrapegraphai-1.3.0b1/examples/mixed_models/inputs/books.xml`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/mixed_models/inputs/example.json` & `scrapegraphai-1.3.0b1/examples/mixed_models/inputs/example.json`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/mixed_models/inputs/plain_html_example.txt` & `scrapegraphai-1.3.0b1/examples/mixed_models/inputs/plain_html_example.txt`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/openai/csv_scraper_openai.py` & `scrapegraphai-1.3.0b1/examples/openai/csv_scraper_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/openai/custom_graph_openai.py` & `scrapegraphai-1.3.0b1/examples/openai/custom_graph_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/openai/deep_scraper_openai.py` & `scrapegraphai-1.3.0b1/examples/openai/deep_scraper_openai.py`
...
### Comparing `scrapegraphai-1.3.0/examples/openai/json_scraper_openai.py` & `scrapegraphai-1.3.0b1/examples/openai/json_scraper_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/openai/omni_scraper_openai.py` & `scrapegraphai-1.3.0b1/examples/openai/omni_scraper_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/openai/omni_search_graph_openai.py` & `scrapegraphai-1.3.0b1/examples/openai/omni_search_graph_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/openai/scrape_plain_text_openai.py` & `scrapegraphai-1.3.0b1/examples/openai/scrape_plain_text_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/openai/script_generator_openai.py` & `scrapegraphai-1.3.0b1/examples/openai/script_generator_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/openai/search_graph_openai.py` & `scrapegraphai-1.3.0b1/examples/openai/search_graph_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/openai/smart_scraper_openai.py` & `scrapegraphai-1.3.0b1/examples/openai/smart_scraper_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/openai/speech_graph_openai.py` & `scrapegraphai-1.3.0b1/examples/openai/speech_graph_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/openai/xml_scraper_openai.py` & `scrapegraphai-1.3.0b1/examples/openai/xml_scraper_openai.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/openai/inputs/books.xml` & `scrapegraphai-1.3.0b1/examples/openai/inputs/books.xml`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/openai/inputs/example.json` & `scrapegraphai-1.3.0b1/examples/openai/inputs/example.json`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/openai/inputs/plain_html_example.txt` & `scrapegraphai-1.3.0b1/examples/openai/inputs/plain_html_example.txt`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/single_node/fetch_node.py` & `scrapegraphai-1.3.0b1/examples/single_node/fetch_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/single_node/image2text_node.py` & `scrapegraphai-1.3.0b1/examples/single_node/image2text_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/examples/single_node/robot_node.py` & `scrapegraphai-1.3.0b1/examples/single_node/robot_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/manual deployment/commit_and_push.sh` & `scrapegraphai-1.3.0b1/manual deployment/commit_and_push.sh`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/manual deployment/commit_and_push_with_tests.sh` & `scrapegraphai-1.3.0b1/manual deployment/commit_and_push_with_tests.sh`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/builders/graph_builder.py` & `scrapegraphai-1.3.0b1/scrapegraphai/builders/graph_builder.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/docloaders/chromium.py` & `scrapegraphai-1.3.0b1/scrapegraphai/docloaders/chromium.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/graphs/__init__.py` & `scrapegraphai-1.3.0b1/scrapegraphai/graphs/__init__.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/graphs/abstract_graph.py` & `scrapegraphai-1.3.0b1/scrapegraphai/graphs/abstract_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/graphs/base_graph.py` & `scrapegraphai-1.3.0b1/scrapegraphai/graphs/base_graph.py`
...
### Comparing `scrapegraphai-1.3.0/scrapegraphai/graphs/csv_scraper_graph.py` & `scrapegraphai-1.3.0b1/scrapegraphai/graphs/csv_scraper_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/graphs/deep_scraper_graph.py` & `scrapegraphai-1.3.0b1/scrapegraphai/graphs/smart_scraper_graph.py`
...
### Comparing `scrapegraphai-1.3.0/scrapegraphai/graphs/json_scraper_graph.py` & `scrapegraphai-1.3.0b1/scrapegraphai/graphs/json_scraper_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/graphs/omni_scraper_graph.py` & `scrapegraphai-1.3.0b1/scrapegraphai/graphs/omni_scraper_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/graphs/omni_search_graph.py` & `scrapegraphai-1.3.0b1/scrapegraphai/graphs/omni_search_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/graphs/pdf_scraper_graph.py` & `scrapegraphai-1.3.0b1/scrapegraphai/graphs/pdf_scraper_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/graphs/script_creator_graph.py` & `scrapegraphai-1.3.0b1/scrapegraphai/graphs/script_creator_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/graphs/search_graph.py` & `scrapegraphai-1.3.0b1/scrapegraphai/graphs/search_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/graphs/smart_scraper_graph.py` & `scrapegraphai-1.3.0b1/scrapegraphai/graphs/xml_scraper_graph.py`
...
### Comparing `scrapegraphai-1.3.0/scrapegraphai/graphs/speech_graph.py` & `scrapegraphai-1.3.0b1/scrapegraphai/graphs/speech_graph.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/graphs/xml_scraper_graph.py` & `scrapegraphai-1.3.0b1/scrapegraphai/graphs/deep_scraper_graph.py`
...
### Comparing `scrapegraphai-1.3.0/scrapegraphai/helpers/models_tokens.py` & `scrapegraphai-1.3.0b1/scrapegraphai/helpers/models_tokens.py`
...
### Comparing `scrapegraphai-1.3.0/scrapegraphai/helpers/nodes_metadata.py` & `scrapegraphai-1.3.0b1/scrapegraphai/helpers/nodes_metadata.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/helpers/schemas.py` & `scrapegraphai-1.3.0b1/scrapegraphai/helpers/schemas.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/models/bedrock.py` & `scrapegraphai-1.3.0b1/scrapegraphai/models/bedrock.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/models/gemini.py` & `scrapegraphai-1.3.0b1/scrapegraphai/models/gemini.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/models/openai_itt.py` & `scrapegraphai-1.3.0b1/scrapegraphai/models/openai_itt.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/models/openai_tts.py` & `scrapegraphai-1.3.0b1/scrapegraphai/models/openai_tts.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/__init__.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/__init__.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/base_node.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/base_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/conditional_node.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/conditional_node.py`
...
### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/fetch_node.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/fetch_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/generate_answer_csv_node.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/generate_answer_csv_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/generate_answer_node.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/generate_answer_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/generate_answer_omni_node.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/generate_answer_omni_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/generate_answer_pdf_node.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/generate_answer_pdf_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/generate_scraper_node.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/generate_scraper_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/get_probable_tags_node.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/get_probable_tags_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/graph_iterator_node.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/graph_iterator_node.py`
...
### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/image_to_text_node.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/image_to_text_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/merge_answers_node.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/merge_answers_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/parse_node.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/parse_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/rag_node.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/rag_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/robots_node.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/robots_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/search_internet_node.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/search_internet_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/search_link_node.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/search_link_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/nodes/text_to_speech_node.py` & `scrapegraphai-1.3.0b1/scrapegraphai/nodes/text_to_speech_node.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/utils/cleanup_html.py` & `scrapegraphai-1.3.0b1/scrapegraphai/utils/cleanup_html.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/utils/convert_to_csv.py` & `scrapegraphai-1.3.0b1/scrapegraphai/utils/convert_to_csv.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/utils/convert_to_json.py` & `scrapegraphai-1.3.0b1/scrapegraphai/utils/convert_to_json.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/utils/parse_state_keys.py` & `scrapegraphai-1.3.0b1/scrapegraphai/utils/parse_state_keys.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/utils/prettify_exec_info.py` & `scrapegraphai-1.3.0b1/scrapegraphai/utils/prettify_exec_info.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/utils/proxy_rotation.py` & `scrapegraphai-1.3.0b1/scrapegraphai/utils/proxy_rotation.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/utils/research_web.py` & `scrapegraphai-1.3.0b1/scrapegraphai/utils/research_web.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/utils/save_audio_from_bytes.py` & `scrapegraphai-1.3.0b1/scrapegraphai/utils/save_audio_from_bytes.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/utils/sys_dynamic_import.py` & `scrapegraphai-1.3.0b1/scrapegraphai/utils/sys_dynamic_import.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/scrapegraphai/utils/token_calculator.py` & `scrapegraphai-1.3.0b1/scrapegraphai/utils/token_calculator.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/tests/graphs/scrape_json_ollama.py` & `scrapegraphai-1.3.0b1/tests/graphs/scrape_json_ollama.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/tests/graphs/scrape_plain_text_llama3_test.py` & `scrapegraphai-1.3.0b1/tests/graphs/scrape_plain_text_llama3_test.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/tests/graphs/scrape_plain_text_mistral_test.py` & `scrapegraphai-1.3.0b1/tests/graphs/scrape_plain_text_mistral_test.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/tests/graphs/scrape_xml_ollama_test.py` & `scrapegraphai-1.3.0b1/tests/graphs/scrape_xml_ollama_test.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/tests/graphs/script_generator_test.py` & `scrapegraphai-1.3.0b1/tests/graphs/script_generator_test.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/tests/graphs/smart_scraper_ollama_test.py` & `scrapegraphai-1.3.0b1/tests/graphs/smart_scraper_ollama_test.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/tests/graphs/inputs/books.xml` & `scrapegraphai-1.3.0b1/tests/graphs/inputs/books.xml`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/tests/graphs/inputs/example.json` & `scrapegraphai-1.3.0b1/tests/graphs/inputs/example.json`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/tests/graphs/inputs/plain_html_example.txt` & `scrapegraphai-1.3.0b1/tests/graphs/inputs/plain_html_example.txt`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/tests/nodes/fetch_node_test.py` & `scrapegraphai-1.3.0b1/tests/nodes/fetch_node_test.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/tests/nodes/robot_node_test.py` & `scrapegraphai-1.3.0b1/tests/nodes/robot_node_test.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/tests/utils/test_proxy_rotation.py` & `scrapegraphai-1.3.0b1/tests/utils/test_proxy_rotation.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/tests/utils/test_sys_dynamic_import.py` & `scrapegraphai-1.3.0b1/tests/utils/test_sys_dynamic_import.py`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/LICENSE` & `scrapegraphai-1.3.0b1/LICENSE`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/README.md` & `scrapegraphai-1.3.0b1/README.md`

 * *Files identical despite different names*

### Comparing `scrapegraphai-1.3.0/pyproject.toml` & `scrapegraphai-1.3.0b1/pyproject.toml`
...
### Comparing `scrapegraphai-1.3.0/PKG-INFO` & `scrapegraphai-1.3.0b1/PKG-INFO`
