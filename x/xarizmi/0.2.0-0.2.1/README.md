# Comparing `tmp/xarizmi-0.2.0.tar.gz` & `tmp/xarizmi-0.2.1.tar.gz`
...
## Comparing `xarizmi-0.2.0.tar` & `xarizmi-0.2.1.tar`
...
### Comparing `xarizmi-0.2.0/LICENSE` & `xarizmi-0.2.1/LICENSE`

 * *Files identical despite different names*

### Comparing `xarizmi-0.2.0/PKG-INFO` & `xarizmi-0.2.1/PKG-INFO`
...
### Comparing `xarizmi-0.2.0/setup.py` & `xarizmi-0.2.1/setup.py`

 * *Files identical despite different names*

### Comparing `xarizmi-0.2.0/tests/test_candlestick.py` & `xarizmi-0.2.1/tests/test_candlestick.py`

 * *Files identical despite different names*

### Comparing `xarizmi-0.2.0/xarizmi.egg-info/PKG-INFO` & `xarizmi-0.2.1/xarizmi.egg-info/PKG-INFO`
